# faultline-decision-observability: STRIDE Threat Model & Information Security

Security analysis for **Decision Observability & Provenance-First Calibration Ledger**.

# faultline-decision-observability: Architecture & System Topology

**Domain**: Decision Observability & Provenance-First Calibration Ledger  
**Description**: Observability platform for high-stakes decisions tracking belief drift, counterfactual simulations, and cryptographic evidence provenance.
...
sequenceDiagram
    ...
    participant Engine as faultline-decision-observability Core
